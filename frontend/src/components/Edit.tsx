...
export default function Edit() {
    ...
    return (
        <>
            <div className="bg-black items-center justify-center flex h-screen">
                ...
                <div className="w-[30rem] h-28rem] bg-white rounded-lg">
                    <div className="flex flex-col">
                        <div className=" w-full flex p-4 justify-between">
                            ...
                            <div>
                                <svg className="rotate-45 cursor-pointer h-7 w-7 text-gray-500" width="24" height="24" viewBox="0 0 24 24" stroke-width="1.6" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">  <path stroke="none" d="M0 0h24v24H0z" />  <line x1="12" y1="5" x2="12" y2="19" />  <line x1="5" y1="12" x2="19" y2="12" /></svg>
